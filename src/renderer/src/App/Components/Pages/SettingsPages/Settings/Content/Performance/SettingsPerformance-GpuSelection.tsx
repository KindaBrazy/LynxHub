...
export default function SettingsPerformanceGpuSelection() {
    ...
    const descriptionText = 'Uses dedicated GPU instead of integrated graphics. Useful for multi-GPU systems (laptops with discrete graphics).';

    return (
        <SettingsFilterItem searchTexts={[titleText, descriptionText, 'gpu', 'dedicated', 'discrete', 'integrated', 'graphics', 'laptop']}>
            <LynxSwitch
                title={titleText}
